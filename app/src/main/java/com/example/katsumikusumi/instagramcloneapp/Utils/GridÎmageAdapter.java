...
public class GridÎmageAdapter extends ArrayAdapter<String> {
    ...
    public GridÎmageAdapter(Context context, int layoutResource, String append, ArrayList<String> imgURLs) {
